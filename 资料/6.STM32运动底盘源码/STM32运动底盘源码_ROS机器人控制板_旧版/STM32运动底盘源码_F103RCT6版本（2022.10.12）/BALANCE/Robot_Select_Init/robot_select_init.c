...
void Robot_Select(void)
{
  ...
  //ADC值分段变量，取决于小车型号数量
	...
	//Collect the pin information of potentiometer 
	//采集电位器引脚信息	
	...
	#elif Diff_Car
	{
		if (Car_Mode==0)  Robot_Init(SENIOR_DIFF_wheelspacing,           0, MD36N_27, Photoelectric_500, SENIOR_DIFF_Tyre_Diameter);//SENIOR_DIFF_27 - 高配差速常规型  
		if (Car_Mode==1)  Robot_Init(SENIOR_DIFF_wheelspacing,           0, MD36N_51, Photoelectric_500, SENIOR_DIFF_Tyre_Diameter);//SENIOR_DIFF_51 - 高配差速重载型
		...
		if (Car_Mode==6)  Robot_Init(FlagShip_FOUR_WHEEL_DIFF_BS_wheelspacing, 0, MD60N_18, Photoelectric_500, FOUR_WHEEL_DIFF_Tyre_Diameter);//FlagShip_FOUR_WHEEL_DIFF_BS_18 - 旗舰版四轮两驱摆式悬挂常规型
		if (Car_Mode==7)  Robot_Init(FlagShip_FOUR_WHEEL_DIFF_BS_wheelspacing, 0, MD60N_47, Photoelectric_500, FOUR_WHEEL_DIFF_Tyre_Diameter);//FlagShip_FOUR_WHEEL_DIFF_BS_47 - 旗舰版四轮两驱摆式悬挂重载型
		if (Car_Mode==8)  Robot_Init(FlagShip_FOUR_WHEEL_DIFF_DL_wheelspacing, 0, MD60N_18, Photoelectric_500, FOUR_WHEEL_DIFF_Tyre_Diameter);//FlagShip_FOUR_WHEEL_DIFF_DL_18 - 旗舰版四轮两驱独立悬挂常规型
		if (Car_Mode==9)  Robot_Init(FlagShip_FOUR_WHEEL_DIFF_DL_wheelspacing, 0, MD60N_47, Photoelectric_500, FOUR_WHEEL_DIFF_Tyre_Diameter);//FlagShip_FOUR_WHEEL_DIFF_DL_47 - 旗舰版四轮两驱独立悬挂重载型
  }
	#endif
}
